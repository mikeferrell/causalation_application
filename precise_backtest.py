...
def backtesting_buy_recommendation_list():
    ...
    for dates in end_date_list:
        ...
        #backtest process begins here
        #Need to figure out how to implement the end_date into this process. There is no exact end-date column. Query
        #is currently in Mode, so check it out.
