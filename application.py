...
scheduler.add_job(cron_jobs.update_stock_data_russell, 'cron', day_of_week='tue-sat', hour=1, minute=50)
...
scheduler.add_job(cron_jobs.keyword_count_cron_job, 'cron', day_of_week='tue-sat', hour=1, minute=59)
