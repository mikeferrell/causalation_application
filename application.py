...
scheduler.add_job(cron_jobs.top_correlation_scores, 'cron', day_of_week='tue', hour=20, minute=1)
scheduler.add_job(cron_jobs.top_correlation_scores, 'cron', day_of_week='fri', hour=20, minute=1)
scheduler.add_job(cron_jobs.weekly_stock_opening_cron_job, 'cron', day_of_week='tue-sat', hour=20, minute=20)
