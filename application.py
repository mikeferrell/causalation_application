...
scheduler.add_job(cron_jobs.top_correlation_scores('asc'), 'cron', day_of_week='tue-sat', hour=1, minute=59)
scheduler.add_job(cron_jobs.top_correlation_scores('desc'), 'cron', day_of_week='tue-sat', hour=2, minute=19)
